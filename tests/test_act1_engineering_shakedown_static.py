...
class Act1EngineeringShakedownStaticTests(unittest.TestCase):
    ...
    def test_engineering_sequence_text_and_objectives_exist_in_order(self) -> None:
        ...
        for phrase in [
            "Captain: You are cleared for departure. Take Artemis at least 2 km off the station.",
            "Engineering: On the captain's order, set Impulse to 0% and Warp to 200% so we can validate your heat sinks.",
            "Helm: Confirm impulse speed reads zero, then go to warp 1. Let the speed settle and report it to the captain.",
            "Good. Everything checks out so far. Let us exercise internal coordination next.\\nEngineering: Select a crew quarters, set a rally point there, and assign one of your DAMCON teams to it. That sets where they wait between jobs. Selecting a team also shows you its medical status.",
            "Confirmed.",
            "Engineering: Your crew works fastest when they get real time in quarters, the mess, and the gym. Injured teams belong in sickbay. They are dedicated enough to run themselves into the ground, which puts the burden on you to manage them well. Take care of your crew when the pressure is low and they will take care of you when the pressure is high.",
            "Engineering: We are going to run a controlled overload to exercise damage control. Set Impulse, Warp, and Maneuver to 300%. Watch your system heat and how your DAMCON teams respond to the failure.",
            "Engineering: Set Impulse, Warp, and Maneuver to 300% and let them overload. Once they blow, bleed off the excess heat, track your DAMCON teams through the repair, then bring the systems back to 100%.",
            "Rested, fed, and exercised teams move noticeably faster. Quarters, mess, and gym each earn a separate bonus.",
            "We have the damage on our board. Repairs are yours to supervise. Watch the difference in how quickly a rested team crosses the ship compared to one that has not stood down. Manage your crew well.\\nComms: Confirm when Engineering reports repairs complete.",
            "Everything checks out. Engineering: leave Impulse at 100%, set Warp to 10%, and set Maneuver to 190%. Press S at the bottom left of your console, then press 2 to save that as a preset. Call it your close-quarters profile. Think through which systems you will want in a fight, in a transit, and under tow, and build a preset for each.",
            "Engineering shakedown complete. Comms: confirm when the captain is ready and we will put a training drone in the water for you.",
