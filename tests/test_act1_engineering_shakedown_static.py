...
class Act1EngineeringShakedownStaticTests(unittest.TestCase):
    ...
    def test_engineering_sequence_text_and_objectives_exist_in_order(self) -> None:
        ...
        for phrase in [
            ...
            "So far everything checks out. Engineering: Set all controls to 100% except for Engines. Leave Impuse at 100%, Set Warp at 10%, and set Manuver at 190%. Press the S button at the bottom left of your screen and then press 2, a little to the right on your screen. This will be the start of a combat preset. Think through which systems you are likely to need in various situations and configure your presets.",
            "Engineering shaekdown complete. On Comm: Confirm your readiness for us to deploy drone 01 for some basic target practice.",
