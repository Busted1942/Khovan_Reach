# KHOVAN REACH — QUALIFICATION CARDS

*Final per-station qualification cards. GM-only — players never see these during play. Surfaced at debrief by Dillon.*
...
Did the captain effectively coordinate the salvager situation — delegating to Comms appropriately, authorizing Weapons readiness at the right time, making the force-authorization call when the pirates exposed themselves?
...
- NEEDS RETEST: No effective coordination; salvager situation resolved by other stations or by GM intervention
...
Did Helm hold station alongside Halcyon Drift during the away mission and through the rescue, including during salvager arrival?
...
Did Weapons maintain appropriate threat readiness during the salvager presence — weapons hot when authorized, fire discipline until exposure was confirmed, decisive engagement once authorized?
...
If the Engineer stayed aboard Halcyon Drift during salvager arrival, note this as additional context — they were in real personal danger and held their position effectively. This is not a separate qualification item but worth acknowledging in debrief.
...
When the salvagers arrived, did Science scan them and surface the suspicious indicators (weapons signatures, boarding gear, transponder mismatches)?
...
The revised Act I drill block observes one taught sequence and one independent transfer task:

- Drill Two: guided passive target, Weapons subsystem disabled.
- Drill Three: unguided evasive/live-fire target, Engine subsystem disabled.

Do not score Drill Two and Drill Three as equivalent. Drill Two is a training exposure. Drill Three is the stronger qualification signal.
