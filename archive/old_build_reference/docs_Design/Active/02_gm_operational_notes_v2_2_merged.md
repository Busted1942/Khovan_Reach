...
Supersedes: `02_gm_operational_notes_v2_1_merged.md` and `02_gm_operational_notes.md` for active use  
Pair with: `khovan_reach_pass1_v2_2_merged.md`, Pass 2 content files, `01_qualification_cards_v2_2_merged.md`, `04_debrief_script_v2_2.md`, `03_damcon_reports_v2_2.md`, and `03_mast_requirements_v2_2_merged.md`

---

# 1. GM operating stance

**v2.2 cleanup note:** Use this guide with the v2.2 source index. Older Pass 3 GM notes and v2.0/v2.1 handoff references are archived.
