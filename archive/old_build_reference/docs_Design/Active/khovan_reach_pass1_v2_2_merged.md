...
- Corrected DAMCON outcome thresholds in Scene 14 and timing notes to match v2.2 source index and GM notes: extended T+30 total-loss threshold, compressed T+15 total-loss threshold.
